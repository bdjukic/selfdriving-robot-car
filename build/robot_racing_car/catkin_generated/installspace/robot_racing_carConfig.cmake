...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_racing_car' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bogdan/Projects/robotRacingCar/install/${idir}'.  Ask the maintainer 'Bogdan Djukic <bdjukic@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/bogdan/Projects/robotRacingCar/install/lib;/home/bogdan/Projects/robotRacingCar/devel/lib;/opt/ros/kinetic/lib)
