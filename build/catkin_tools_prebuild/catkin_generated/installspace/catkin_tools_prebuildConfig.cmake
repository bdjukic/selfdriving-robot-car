...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bogdan/Projects/selfdriving-robot-car/install/${idir}'.  Ask the maintainer 'jbohren <jbo@jhu.edu>' to fix it.")
    endif()
